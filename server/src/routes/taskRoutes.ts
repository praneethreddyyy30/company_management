...
// POST /api/tasks - Create a task (Admin or Lead)
router.post("/", authenticateJWT as any, requireRole(["Admin", "Lead"]) as any, createTask as any);
...
// DELETE /api/tasks/:id - Delete a task (Admin or Lead)
router.delete("/:id", authenticateJWT as any, requireRole(["Admin", "Lead"]) as any, deleteTask as any);
