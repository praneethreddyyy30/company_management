...
// PUT /api/leaves/:id/status - Approve or reject leave (Admin or Lead)
router.put("/:id/status", authenticateJWT as any, requireRole(["Admin", "Lead"]) as any, updateLeaveStatus as any);
